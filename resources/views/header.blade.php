    ...
    <div class="container-fluid d-flex align-items-center justify-content-between flex-nowrap position-relative">
        ...
        <div class="d-flex align-items-center gap-2 ms-auto flex-shrink-0" id="headerButtons">
            ...
            <div class="flex flex-row gap-1 align-items-center">
                ...
                <button class="btn btn-outline-light btn-sm rounded-pill px-2 px-sm-3 py-1 text-nowrap flex items-center gap-[0.6rem]" data-bs-toggle="offcanvas" data-bs-target="#accountPanel"><span>{{$userData->currency}} : {{$userData->wallet_amount}} </a></span></button>
